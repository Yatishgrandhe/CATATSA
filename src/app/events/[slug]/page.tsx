...
export default function EventPage() {
  ...
  if (!event) {
    return (
      <div className="App">
        <Navigation />
        <main className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center pt-24">
  ...
  return (
    <div className="App">
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 pt-24 overflow-hidden">
              ...
              <div className="card shadow-2xl animate-scale-in">
                ...
                {event.comingSoon && (
                  <div className="mb-10 animate-fade-in">
                    <div className="relative bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 text-white rounded-2xl p-8 md:p-10 text-center overflow-hidden shadow-2xl">
